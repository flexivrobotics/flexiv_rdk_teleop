...
/**
 * @enum Mode
 * @brief flexiv::Mode extended with teleoperation modes.
 */
enum Mode
{
    //============================= STANDARD MODES =============================
    ...
    //========================== TELEOPERATION MODES ===========================
    /**
     * Function as the remote robot for teleoperation.
     * @note Timeliness adaptive mode: communication delay is allowed.
     * @see flexiv::Robot::commandToRemote()
     */
    MODE_TELEOP_REMOTE = 10,

    /**
     * Function as the local robot for teleoperation.
     * @note Timeliness adaptive mode: communication delay is allowed.
     * @see flexiv::Robot::commandToLocal()
     */
    MODE_TELEOP_LOCAL = 11,
};
