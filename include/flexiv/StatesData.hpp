...
/**
 * @struct RobotStates
 * @brief Data struct containing standard joint- and Cartesian-space robot
 * states, plus add-on states for teleoperation.
 */
struct RobotStates
{
    /**
    ...
    /** Anonymous states data exchanged between local and remote robot for
     * internal teleoperation algorithms */
    struct TeleopAlgData
    {
        double P1 = {};
